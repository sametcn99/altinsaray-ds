...
export default function ScrollTop() {
  ...
  return (
    <>
      {visible && (
        <div
          className={`fixed bottom-4 right-4 z-10 flex h-5 w-5 items-center justify-center rounded-lg bg-accent-500 bg-opacity-50 p-4 backdrop-blur-sm hover:shadow-xl`}
        >
          <button
